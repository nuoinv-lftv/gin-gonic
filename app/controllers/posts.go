...
// CreatePost is a function create posts
func (server *Server) CreatePost(w http.ResponseWriter, r *http.Request) {
	...
	repositories.JSON(w, http.StatusCreated, postCreated)
}

// GetPosts is function get all information post
func (server *Server) GetPosts(w http.ResponseWriter, r *http.Request) {
	...
	repositories.JSON(w, http.StatusOK, posts)
}

// GetPost is function get information one post
func (server *Server) GetPost(w http.ResponseWriter, r *http.Request) {
	...
	repositories.JSON(w, http.StatusOK, postReceived)
}

// UpdatePost is function update info post
func (server *Server) UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		repositories.ERROR(w, http.StatusNotFound, errors.New("Post not found"))
		return
	}
	...
	repositories.JSON(w, http.StatusOK, postUpdated)
}

// DeletePost is a function remove post
func (server *Server) DeletePost(w http.ResponseWriter, r *http.Request) {
	...
	err = server.DB.Debug().Model(models.Post{}).Where("id = ?", pid).Take(&post).Error
	if err != nil {
		repositories.ERROR(w, http.StatusNotFound, errors.New("Unauthorized"))
		return
	}
